...
::L7::
            do
               ...
               do
                  local v10 = ffi.cast("uint32_t*", P+28)[0]
                  local v11 = bit.band(v10,255)
                  if v11 == 127 then return true end
                  do
                     local v12 = ffi.cast("uint32_t*", P+38)[0]
                     local v13 = bit.band(v12,255)
                     do return v13 == 127 end
                  end
               end
            end
         end
