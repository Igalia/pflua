...
local primitive_expanders = {
   ...
   lat = function(expr) return has_ether_protocol(24580) end,
   moprc = function(expr) return has_ether_protocol(24578) end,
   mopdl = function(expr) return has_ether_protocol(24577) end,
   llc = unimplemented,
   ...
   dir = unimplemented,
   vlan = unimplemented,
   mpls = function(expr) return has_ether_protocol(34887) end,
   pppoed = function(expr) return has_ether_protocol(34915) end,
   pppoes = function(expr) return has_ether_protocol(34916) end,
